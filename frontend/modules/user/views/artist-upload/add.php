...
<div id="albumAdmin" class="panel ra-container">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
                <div class="alert alert-warning" role="alert">
                  <?php echo \Yii::t('app', 'uploadAlbumInfo')?>
                </div>
                </div>
          </div>
