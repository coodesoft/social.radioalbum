...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-md-12">
          <button id="backButton" type="button" class="btn ra-btn" aria-label="Left Align">
              ...
              <?php foreach($directories as $directory){ ?>
                  <tr>
                    <td colspan="6" class="left">
                      <span class="directory" data-action="explore" href="<?php echo Url::to(['/admin/tagEditor/nav/navigate', 'navigate' => Html::encode($directory)]) ?>"><?php echo $directory ?></span>
                    </td>
                  </tr>
              <?php } ?>
