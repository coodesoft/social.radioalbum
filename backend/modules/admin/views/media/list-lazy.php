  ...
  <?php foreach($albums as $album) { ?>
    <tr>
      ...
      <td class="actions">
		  ...
		  <?php } else { ?>
          <a data-crud="enable" data-toggle="tooltip" data-placement="left" title="<?php echo \Yii::t('app', 'disable')?>" data-action="nav" href="<?php echo Url::to(['/admin/media/enable', 'id' => $album->id])?>">
            <span class="fa-layers fa-fw">
              <i class="fal fa-circle" data-fa-transform="grow-15"></i>
